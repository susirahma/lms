...
class _HelpPageState extends State<HelpPage> {
  ...
  final Map<String, Map<String, String>> texts = {
    'ID': {
      ...
      'instruction': 'Detail format login Microsoft Office 365:',
      'username': 'Username (Akun iGracias) + \'@365.telkomuniversity.ac.id\'',
      'password': 'Informasi mengenai kewajiban \'Strong Password\' di iGracias.',
      'footer': 'Contact:',
